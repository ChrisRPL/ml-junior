...
REQUIRED_BACKEND_CAPABILITIES = {
    ...
    "/doctor local-inference": "project.local_inference_diagnostics",
    ...
    "/share-traces": "trace.share_visibility",
...
def build_command_registry(command_spec: type[Any]) -> tuple[Any, ...]:
    ...
    return (
        ...
        spec(
            ...
            description="Preview a read-only project handoff summary",
            risk_level="safe",
            mutates_state=False,
            group="project",
        ),
        ...
        spec(
            name="/doctor local-inference",
            description="Inspect local inference endpoint config",
            arguments="[runtime] [model]",
            risk_level="safe",
            mutates_state=False,
            group="project",
        ),
        ...
        spec(
            name="/share-traces",
            description="Show or change trace sharing visibility",
            arguments="[status|public|private]",
            risk_level="high",
            mutates_state=True,
            implemented=False,
            group="evidence",
